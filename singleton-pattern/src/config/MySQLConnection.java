...
public class MySQLConnection {
     ...
     * @param port     A porta para acesso ao banco de dados.
     */
    private MySQLConnection(String dbName, String username, String password, int port) {
        try {
     ...
     */
    public static MySQLConnection getInstance(String dbName, String username, String password, int port) {
        if (instance == null)
            instance = new MySQLConnection(dbName, username, password, port);
        return instance;
    }
    /**
